...
def CaptureData():
    ...
    cmd = subprocess.run("tshark -i \\Device\\NPF_{330F3553-1DDF-4852-8CA8-86ECC4276E88} -f arp -a duration:3600 -w "+pcap+" -F pcap -T fields -e arp.src.proto_ipv4 -e arp.dst.proto_ipv4", capture_output=True)
...
def TransferFile():
    ...
    Output_Directory = "destination folder"
    File2Send = image
